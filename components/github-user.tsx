  ...
  <div className="flex items-center space-x-3">
    ...
    <div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <a href={gitHubUser.html_url} target={"_blank"} aria-label={"GitHub Profile"}><TbBrandGithub size={iconSize} /></a>
        <a href={leetCodeUrl} target={"_blank"} aria-label={"LeetCode Profile"}><TbBrandLeetcode size={iconSize}/></a>
        <a href={`https://x.com/${gitHubUser.twitter_username}`} target={"_blank"} aria-label={"X Profile"}><TbBrandX size={iconSize}/></a>
